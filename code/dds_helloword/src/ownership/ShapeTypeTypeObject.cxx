...
const TypeObject* GetMinimalShapeTypeObject()
{
    ...
    mst_x.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        mst_x.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
    ...
    mst_y.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        mst_y.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
    ...
    mst_shapesize.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        mst_shapesize.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
...
const TypeObject* GetCompleteShapeTypeObject()
{
    ...
    cst_x.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        cst_x.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
    ...
    cst_y.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        cst_y.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
    ...
    cst_shapesize.common().member_flags().IS_DEFAULT(false); // Doesn't apply
    {
        ...
        cst_shapesize.common().member_type_id(*TypeObjectFactory::get_instance()->get_type_identifier(cppType, false));
    }
